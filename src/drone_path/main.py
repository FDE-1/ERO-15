...
def main():
    ...
    while True :
        ...
        max_districts_ = max(max_district_d1_,max_district_d2_,max_district_d3_,max_district_d4_,max_district_d5_)
        if (max_districts_ == max_district_d1_):
            nb_d1_ +=1
        if (max_districts_ == max_district_d2_):
            nb_d2_ +=1
        if (max_districts_ == max_district_d3_):
            nb_d3_ +=1
        if (max_districts_ == max_district_d4_):
            nb_d4_ +=1
        if (max_districts_ == max_district_d5_):
            nb_d5_ +=1
        print(nb_d1_,nb_d2_,nb_d3_,nb_d4_,nb_d5_)
main()